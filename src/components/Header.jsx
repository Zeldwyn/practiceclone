  ...
  return (
    <header className="bg-white w-full flex justify-center py-4">
      <div className="w-full max-w-6xl flex items-center lg:px-0 px-4">
        ...
        <a href="/" className="pl-20 lg:flex hidden">
        ...
        <div className="relative lg:hidden">
          ...
          {/* Dropdown menu */}
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg flex flex-col text-lg overflow-hidden transition-all duration-300">
              {navItems.map((item) => (
                <a
                  key={item.href}
                  href={item.href}
